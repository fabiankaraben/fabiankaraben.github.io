...
export const metadata = {
  title: "Fabián Karaben | Resume - Flutter Developer",
  description: "Resume / CV of Fabián Karaben, Flutter Developer",
  robots: { index: false, follow: true },
};

export default async function FlutterResumePage({ params }: { params: Promise<{ lang: string }> }) {
        ...
        <div className="mx-auto w-[850px] px-4 print:w-auto print:px-0">
          ...
          <div className="bg-white dark:bg-slate-900/50 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800 p-16 print:shadow-none print:border-none print-container print:bg-white print:dark:bg-white">
            ...
            <ResumeHeader 
              ...
              subtitle={t.flutterTitle}
              portfolioUrl={`https://fabiankaraben.github.io/${lang}/flutter`}
            />
            ...
            <ResumeAbout 
              ...
              aboutText={
                <>
                  ...
                  <p className="mt-4">{t.aboutFlutterP2}</p>
                </>
              }
              portfolioUrl={`https://fabiankaraben.github.io/${lang}/flutter`}
