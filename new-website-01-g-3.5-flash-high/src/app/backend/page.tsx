...
export default function BackendHome() {
  ...
  const skills = [
    { name: "Java", desc: "Enterprise, Robustness, OOP, Banking", icon: "java" },
    { name: "Go", desc: "Gin, Echo, WebSockets, Concurrency", icon: "golang" },
    { name: "TypeScript", desc: "Node.js, Express, Hono, API Layering", icon: "typescript" },
    { name: "Spring Boot", desc: "Framework, Dependency Injection, REST APIs", icon: "spring" },
    { name: "Docker", desc: "Containerization, Portability", icon: "docker" },
    { name: "PostgreSQL", desc: "Extensibility, ACID Transactions", icon: "postgresql" },
    { name: "Redis", desc: "In-Memory Caching, Performance", icon: "redis" },
    { name: "AWS", desc: "EC2, S3, RDS, Lambda", icon: "aws" },
    { name: "Kubernetes", desc: "Scaling, Service Orchestration", icon: "kubernetes" },
    { name: "Cloudflare", desc: "Workers, KV, D1, Edge Computing", icon: "cloudflare" },
    { name: "MongoDB", desc: "NoSQL Document DB, High Scale", icon: "mongodb" },
    { name: "SQLite", desc: "D1, Serverless databases, Turso", icon: "sqlite" },
    { name: "Maven", desc: "Build & Dependency Management", icon: "maven" },
    { name: "Hibernate", desc: "JPA ORM, Data Binding", icon: "hibernate" },
    { name: "Python", desc: "FastAPI, Django, Scripting", icon: "python" },
  ];
      ...
      <main className="relative z-10 flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <section id="home" className="pt-32 pb-20 sm:pt-40 sm:pb-28 lg:pt-48 lg:pb-36 flex flex-col items-center text-center">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-slate-200 dark:border-slate-900 bg-white/40 dark:bg-slate-900/40 backdrop-blur-md text-xs font-mono text-slate-500 dark:text-slate-400 mb-6">
            ...
            <span>BACKEND_CORE: RUNNING // MULTI_LANGUAGE_RUNTIME</span>
          </div>
          ...
          <p className="mt-6 max-w-2xl text-base sm:text-lg text-slate-600 dark:text-slate-400 leading-relaxed font-sans">
            Architecting concurrent microservices, highly optimized APIs, and transaction-safe enterprise infrastructures using Go, Java, and Node.js.
          </p>
        ...
        <section id="about" className="py-20 border-t border-slate-200/80 dark:border-slate-900/60">
          ...
          <div className="grid md:grid-cols-5 gap-10 items-center">
            ...
            <div className="md:col-span-4 space-y-4 text-slate-600 dark:text-slate-300 leading-relaxed font-sans">
              <p>
                I&apos;m a backend engineer with extensive experience building the digital backbone of modern web applications. I specialize in designing robust, scalable, and transaction-safe architectures using **Go** (for concurrent, high-throughput microservices), **Java/Spring Boot** (for transactional enterprise platforms), and **Node.js** (for fast, asynchronous API gateway routing).
              </p>
              <p>
                I hold an <strong className="text-slate-900 dark:text-slate-100">AWS</strong> certification and possess a strong background in containerized orchestration (Docker, Kubernetes) and serverless edge technologies (Cloudflare Workers).
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-16">
            ...
            <div>
              <h3 className="text-lg font-mono text-slate-500 dark:text-slate-400 mb-6 flex items-center gap-2">
                ...
                <span>Enterprise Distributed Systems & APIs</span>
              </h3>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <ProjectCard
            ...
            <div>
              <h3 className="text-lg font-mono text-slate-500 dark:text-slate-400 mb-6 flex items-center gap-2">
                ...
                <span>Real World Backend Applications</span>
              </h3>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <ProjectCard
                  title="Wordsus"
                  description="Your Personal Cloud Library. A unified, browser-based reader for PDFs and EPUBs with native-like performance. Powered by a high-efficiency Go backend."
                  image={wordsus}
        ...
        <section id="contact" className="py-20 border-t border-slate-200/80 dark:border-slate-900/60 text-center max-w-3xl mx-auto">
          ...
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed font-sans mb-10">
            Have a project in mind or just want to chat? Feel free to reach out! I&apos;m always open to new opportunities and collaborations in backend architectures and cloud APIs.
          </p>
